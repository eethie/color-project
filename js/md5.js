// Minimal MD5 implementation for client-side password hashing before sending to the API.
function md5(inputString) {
  ...
  var x = convertToWordArray(unescape(encodeURIComponent(inputString)));
